...
> [!IMPORTANT]
> A `background.png` file is required in the project root for DMG styling. If missing, the release pipeline will fail. This file is typically generated by `scripts/generate-dmg-background.swift` during the release process.
